    ...
    <section id="pricing" ref={ref} style={{ padding: '100px 24px', position: 'relative' }}>
      ...
      >
        <div style={{
          ...
          fontSize: 13, color: '#c4b5fd', letterSpacing: '0.05em', textTransform: 'uppercase',
          fontWeight: 600, marginBottom: 24,
        }}>Pricing</div>

        <h2 style={{ fontSize: 'clamp(28px, 4vw, 42px)', marginBottom: 12, color: '#fff', lineHeight: 1.05 }}>
          Freemium today — premium soon
        </h2>
        <p style={{ color: 'rgba(237,233,254,0.6)', maxWidth: 780, margin: '0 auto' }}>
          Visual Memory is available now as a freemium product: core features are free to use forever.
      ...
      <div style={{ maxWidth: 1000, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
        <div style={{ padding: 28, borderRadius: 16, background: 'rgba(13,10,26,0.6)', border: '1px solid rgba(255,255,255,0.06)' }}>
          <div style={{ fontSize: 14, fontWeight: 700, color: '#c4b5fd', marginBottom: 8 }}>Freemium</div>
